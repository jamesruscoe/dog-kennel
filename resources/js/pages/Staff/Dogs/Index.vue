...
function deleteDog() {
    ...
    router.delete(route('staff.dogs.destroy', dogToDelete.value.id), {
        preserveScroll: true,
    });
    ...
    <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden">
        <table v-if="dogs.data.length > 0" class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
            ...
            <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                ...
                >
                    <td class="px-4 py-3">
                        <Link :href="route('staff.dogs.show', dog.id)" class="group">
                    ...
                    <td class="px-4 py-3">
                        <Link
                            v-if="dog.owner"
                            :href="route('staff.owners.show', dog.owner.id)"
                    ...
                    <td class="px-4 py-3 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <Link :href="route('staff.dogs.edit', dog.id)" class="text-xs text-zinc-500 hover:text-indigo-600 transition-colors">Edit</Link>
                            <ConfirmModal
                                title="Remove Dog"

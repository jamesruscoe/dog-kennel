...
const ownerNav = [
    ...
    { label: 'Account',   href: () => tenantRoute('owner.account.edit'),   icon: 'user-circle' },
];
                ...
                <ul class="space-y-0.5">
                    <li v-for="item in navItems" :key="item.label">
                        ...
                        >
                            ...
                            <!-- User circle icon (Account) -->
                            <svg v-else-if="item.icon === 'user-circle'" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
